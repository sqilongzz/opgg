    ...
    public String refreshToken(String token) {
        ...
        try {
            final Claims claims = Jwts.parser()
                    ...
                    .parseClaimsJws(token)
                    .getBody();
            refreshedToken = JwtHelper.createToken(getUserId(token), getUserType(token),getUserName(token));
        } catch (Exception e) {
            refreshedToken = null;
        }
...
//        String token = JwtHelper.createToken( 100l,1);
